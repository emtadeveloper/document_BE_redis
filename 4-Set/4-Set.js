...
به مجموعه دیگر استفاده می‌شود. این دستور یک عملیات اتمی است به این معنی که عضو موردنظر از مجموعه SET برای انتقال یک عضو از یک مجموعه

مبدأ حذف شده و هم‌زمان به مجموعه مقصد اضافه می‌شود

SMOVE source destination member

source: نام مجموعه مبدأ

destination: نام مجموعه مقصد

member: عضوی که باید منتقل شود

ویژگی‌ها:

اگر عضو در مجموعه مبدأ وجود داشته باشد

از مجموعه مبدأ حذف شده و به مجموعه مقصد اضافه می‌شود

نتیجه: 1

اگر عضو در مجموعه مبدأ وجود نداشته باشد

هیچ تغییری در مجموعه‌ها ایجاد نمی‌شود


نتیجه: 0

اگر عضو در مجموعه مقصد قبلاً وجود داشته باشد

به دلیل ماهیت SET که مقادیر تکراری را نمی‌پذیرد، تغییری در مجموعه مقصد ایجاد نمی‌شود


EXAMPLE  ================================================================================================================================

داریم set1 و set2  انتقال یک عضو از یک مجموعه به مجموعه دیگر فرض کنید دو مجموعه با نام‌های 

SADD set1 "Alice" "Bob" "Charlie"

SADD set2 "David" "Eve"

منتقل کنیم  set1 به set2   را از  Alice  حالا می‌خواهیم مقدار

SMOVE set1 set2 "Alice"

نکته : فرض کنید میخایم مقداری را که در مجموعه ای که وجود ندارد منتقل کنیم  در  این حالت با خطای 

(integer) 0  # عضو موردنظر منتقل نشد.
